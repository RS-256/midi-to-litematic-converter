...
export function writeNamedRootCompound( name: string, value: Record< string, NbtTag > ): Uint8Array {
...
function writeCompoundPayload( writer: BinaryWriter, value: Record< string, NbtTag > ): void {
