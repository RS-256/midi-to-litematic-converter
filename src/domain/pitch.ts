...
export function correctNoteBlockPitch( midi: number, baseMidi: number ): CorrectedPitch {
...
export function getPitchStats( track: TrackData, settings: TrackSettings ): Record< PitchCorrection, number > {
