...
export function getPercussionMapping( settings: TrackSettings, midi: number ): PercussionMapping {
  const mapping = settings.percussionMappings.find( ( candidate ) => candidate.midi === midi )
